...
/**
 * The island is one continuous authored footprint. Product tiles sit on top as
 * coast, road-junction and vegetation details; they no longer define whether
 * the city floor exists, so transparent gaps cannot turn into internal lakes.
 */
...
/**
 * Only topology-compatible product tiles are placed in the live map. The full
 * source kit stays registered, but tiles with incompatible exits are not forced
 * into the scene merely to increase the asset count.
 */
